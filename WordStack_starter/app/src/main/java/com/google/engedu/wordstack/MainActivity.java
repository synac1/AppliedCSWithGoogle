    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            while((line = in.readLine()) != null) {
                ...
                /*
                Start by extracting the desired
                 words from the dictionary. In MainActivity.onCreate, we read the words from the file but need to store them in the words ArrayList if they are of the correct size. WORD_LENGTH defaults to
                 5 but feel free to modify it to make the game easier or harder.
                 */
